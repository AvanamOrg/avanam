	...
	public function get_icon( $icon = 'search', $icon_title = '', $base = true, $aria = false ) {
		...
		switch ( $icon ) {
			...
			case 'search':
				...
				break;
			case 'search2':
				$output .= '<svg'. ( ! $aria ? ' aria-hidden="true"' : '' ) . ' class="base-svg-icon base-search2-svg" fill="currentColor" stroke-width="0.20" stroke="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Search', 'avanam' ) ) . '</title>';
				}
