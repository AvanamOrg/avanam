...
$settings = array(
	...
	'sfwd-quiz_title_font' => array(
		...
		'section'      => 'sfwd_quiz_layout_design',
		'label'        => esc_html__( 'Quiz Title Font', 'avanam' ),
	...
	'sfwd-quiz_title_background' => array(
		...
		'section'      => 'sfwd_quiz_layout_design',
		'label'        => esc_html__( 'Quiz Above Area Background', 'avanam' ),
		...
		'input_attrs'  => array(
			'tooltip'  => __( 'Quiz Title Background', 'avanam' ),
		),
	),
	...
	'sfwd-quiz_background' => array(
		...
		'input_attrs'  => array(
			'tooltip' => __( 'Quiz Background', 'avanam' ),
		),
	),
	'sfwd-quiz_content_background' => array(
		...
		'input_attrs'  => array(
			'tooltip' => __( 'Quiz Content Background', 'avanam' ),
		),
	),
);
