...
const GradientTypePicker = ( { gradientAST, hasGradient, onChange } ) => {
	...
	return (
		<SelectControl
			className="components-custom-gradient-picker__type-picker base-select-large"
			label={ __( 'Type' ) }
			labelPosition="top"
...
const GradientPositionPicker = ( { gradientAST, hasGradient, onChange } ) => {
	...
	return (
		<div className={ `components-base-control base-gradient-position-control` }>
				<Flex
					justify="space-between"
					className={ 'base-gradient-position_header' }
				>
					<FlexItem>
						<label className="base-gradient-position__label">{ __( 'Position', 'base-blocks' ) }</label>
					</FlexItem>
				</Flex>
				{ positionType === 'position-keyword' && (
					<div className={ 'base-controls-content' }>
						...
						/>
						<Button
							className={'base-control-toggle-advanced only-icon'}
							label={ __( 'Set custom position', 'base-blocks' ) }
							icon={ settings }
				...
				{ positionType !== 'position-keyword' && (
					<div className={ 'base-controls-content' }>
						...
						<Button
							className={'base-control-toggle-advanced only-icon'}
							label={ __( 'Set standard position', 'base-blocks' ) }
							icon={ settings }
...
const GradientShapePicker = ( { gradientAST, hasGradient, onChange } ) => {
	...
	return (
		<SelectControl
			className="components-custom-gradient-picker__shape-picker base-select-large"
			label={ __( 'Shape', 'base-blocks' ) }
			labelPosition="top"
			onChange={ onShapeChange }
			options={ [
				{ value: 'ellipse', label: __( 'Ellipse', 'base-blocks'  ) },
				{ value: 'circle', label: __( 'Circle', 'base-blocks'  ) },
			] }
...
export default function CustomGradientPicker( {
	...
	return (
		<div className={ 'components-base-control components-custom-gradient-picker base-gradient-control' }>
